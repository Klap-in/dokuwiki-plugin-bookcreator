...
$lang['toprint']               = '選択したページ';
$lang['removed']               = '選択から削除したページ';
$lang['reset']                 = '選択の破棄';
$lang['js']['include']         = '選択へ追加';
$lang['js']['remove']          = '選択からページを削除する。';
$lang['js']['sortable']        = 'ページをソート・削除・追加するためにドラッグ＆ドロップする。';
$lang['js']['showpage']        = 'ページを表示する。';
$lang['js']['confirmdel']      = '本当にこの選択をアーカイブから削除する？';
$lang['js']['confirmload']     = '本当に既選択のページに換えて、この選択を読み込みますか？';
$lang['js']['btn_addtobook']   = 'ブックに追加';
$lang['js']['btn_removetobook'] = 'ブックから削除';
$lang['export']                = '選択を出力する。';
$lang['create']                = '出力';
...
$lang['showselection']         = '保存された選択肢を表示する';
$lang['delselection']          = '保存済選択を削除する。';
$lang['loadselection']         = '保存済選択を読み込む。';
$lang['selectionstored']       = '選択を保存した';
$lang['selectiondeleted']      = '選択を削除した';
$lang['selectiondontexist']    = '\'%s\' ページに選択が存在しません';
$lang['selectionforbidden']    = '\'%s\' ページの選択にアクセスできません';
$lang['titlepreparedownload']  = 'ダウンロードの準備中...';
